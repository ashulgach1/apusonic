...
(function(){
  var DICT = {
    en: {
      ...
      'sound.idle':'Sound','sound.playing':'Now playing',
      'hero.tagline':'Sound from the summit','scrollcue':'Descend',
      'apu.quote':'In the Andes, the great mountain that watches over its people is called an <span class="red">Apu</span>.',
      'manifesto.lead':'We don’t license Peru’s sound.<br><span class="red">We originate it.</span>',
      'mani.1.h':'<span class="pk">▲</span> The origination edge',
      ...
      'mani.2.h':'<span class="pk">▲</span> The rights engine',
      ...
      'mani.3.h':'<span class="pk">▲</span> The only partner you need',
      ...
      'foot.apu':'<em>Apu</em>, the living spirit of a mountain. A sonic origination and rights house in Lima, Perú.',
    ...
    es: {
      ...
      'sound.idle':'Sonido','sound.playing':'Reproduciendo',
      'hero.tagline':'Sonido desde la cumbre','scrollcue':'Desciende',
      'apu.quote':'En los Andes, la gran montaña que vela por su pueblo se llama <span class="red">Apu</span>.',
      'manifesto.lead':'No licenciamos el sonido del Perú.<br><span class="red">Lo originamos.</span>',
      'mani.1.h':'<span class="pk">▲</span> La ventaja de originar',
      ...
      'mani.2.h':'<span class="pk">▲</span> El motor de derechos',
      ...
      'mani.3.h':'<span class="pk">▲</span> El único socio que necesitas',
      ...
      'foot.apu':'<em>Apu</em>, el espíritu viviente de una montaña. Una casa de creación sonora y gestión de derechos en Lima, Perú.',
    ...
    pt: {
      ...
      'sound.idle':'Som','sound.playing':'Reproduzindo',
      'hero.tagline':'Som vindo do cume','scrollcue':'Desça',
      'apu.quote':'Nos Andes, a grande montanha que zela por seu povo é chamada de <span class="red">Apu</span>.',
      'manifesto.lead':'Não licenciamos o som do Peru.<br><span class="red">Nós o originamos.</span>',
      'mani.1.h':'<span class="pk">▲</span> A vantagem de originar',
      ...
      'mani.2.h':'<span class="pk">▲</span> O motor de direitos',
      ...
      'mani.3.h':'<span class="pk">▲</span> O único parceiro de que você precisa',
      ...
      'foot.apu':'<em>Apu</em>, o espírito vivo de uma montanha. Uma casa de criação sonora e gestão de direitos em Lima, Peru.',
