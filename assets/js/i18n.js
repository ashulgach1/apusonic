...
(function(){
  var DICT = {
    en: {
      ...
      'mani.1.p':'We don’t pull tracks off a shelf. We write them, and record them with a full orchestra in Lima, so the work feels local, performs nationally, and moves people.',
      ...
      /* banner.1 states a capability ("we record with…"), not a past session —
         the image is an illustration, so a completed-work claim would be false */
      'banner.1':'Written for a full orchestra, recorded in Lima.',
      ...
      /* Gov work in Peru runs through Ley 30225 tenders (RNP-registered bidders),
         not direct award — the copy says "we bid", never "we're appointed" */
      'mk.4.p':'State commissions, civic anthems, and original orchestral works. We take part through public tender as a registered supplier, bringing permanent sound to public projects — written to stand for a country and registered to endure.',
      ...
      'foot.leg1':'Privacy Policy','foot.leg2':'Terms of Use','foot.leg3':'Cookie Policy',
      'foot.leg4':'Corporate Governance','foot.leg5':'Whistleblowing Channel','foot.manage':'Cookie preferences',
    ...
    es: {
      ...
      'mani.1.p':'No sacamos pistas de un estante. Las componemos y las grabamos con orquesta completa en Lima, para que la obra se sienta local, funcione a nivel nacional y emocione a la gente.',
      ...
      'banner.1':'Escrito para orquesta completa, grabado en Lima.',
      ...
      'mk.4.p':'Encargos del Estado, himnos cívicos y obras orquestales originales. Participamos por la vía del concurso público como proveedor inscrito, llevando sonido permanente a los proyectos públicos — escrito para representar a un país y registrado para perdurar.',
      ...
      'foot.leg1':'Política de Privacidad','foot.leg2':'Términos de Uso','foot.leg3':'Política de Cookies',
      'foot.leg4':'Gobierno Corporativo','foot.leg5':'Canal de Denuncias','foot.manage':'Preferencias de cookies',
    ...
    pt: {
      ...
      'mani.1.p':'Não tiramos faixas de uma prateleira. Nós as compomos e gravamos com orquestra completa em Lima, para que a obra soe local, funcione em todo o país e emocione as pessoas.',
      ...
      'banner.1':'Escrito para orquestra completa, gravado em Lima.',
      ...
      'mk.4.p':'Encomendas do Estado, hinos cívicos e obras orquestrais originais. Participamos por meio de licitação pública como fornecedor registrado, levando som permanente aos projetos públicos — escrito para representar um país e registrado para perdurar.',
      ...
      'foot.leg1':'Política de Privacidade','foot.leg2':'Termos de Uso','foot.leg3':'Política de Cookies',
      'foot.leg4':'Governança Corporativa','foot.leg5':'Canal de Denúncias','foot.manage':'Preferências de cookies',
